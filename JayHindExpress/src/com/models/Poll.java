...
@Entity
@Table(name = "tbl_poll_info", uniqueConstraints = {
...
*/
	...
	@Column(name = "opinion_yes", nullable = false)
	public Long getYes() {
		return yes;
	}
	...
	@Column(name = "opinion_no", nullable = false)
	public Long getNo() {
		return no;
	}
	...
	@Column(name = "opinion_none", nullable = false)
	public Long getNone() {
		return none;
	}
