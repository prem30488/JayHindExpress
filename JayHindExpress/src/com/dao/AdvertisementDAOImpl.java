...
public class AdvertisementDAOImpl extends HibernateDaoSupport implements AdvertisementDAO{
	...
	@Override
	@Transactional
	public void delete(Advertisement dept) {
	...
	@Override
	@Transactional
	public Advertisement findByDeptId(Long deptId) {
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		Advertisement dept = (Advertisement) session.get(Advertisement.class, deptId);
		tx.commit();
		session.close();
		return dept;
	}
	...
	public Boolean updateFrequency(Long deptId) {
		Advertisement p = findByDeptId(deptId);
	...
	@Override
	@Transactional
	public DataSet<Advertisement> findAdvertisementWithDatatablesCriterias(
			DatatablesCriterias criterias) {
		List<Advertisement> Advertisements = findAdvertisementsCriterias(criterias);
		Long count = getTotalCount();
		Long countFiltered = getFilteredCount(criterias);

		return new DataSet<Advertisement>(Advertisements, count, countFiltered);
	}
	...
	public List<Advertisement> list(){
		...
		session.setFlushMode(FlushMode.ALWAYS);
		Transaction tx = session.beginTransaction();
		Query q = session.createQuery("from Advertisement");
		List<Advertisement> list = (List<Advertisement>) q.list();
		tx.commit();
		session.close();
		return list;
	}
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<Advertisement> list(Long start,Long end){
	...
	private Long getFilteredCount(DatatablesCriterias criterias) {
		StringBuilder queryBuilder = new StringBuilder("SELECT d FROM Advertisement d");
	...
	private Long getTotalCount() {
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		Query q = session.createQuery("SELECT COUNT(d) FROM Advertisement d");
	...
	@SuppressWarnings("unchecked")
	private List<Advertisement> findAdvertisementsCriterias(
			DatatablesCriterias criterias) {
		StringBuilder queryBuilder = new StringBuilder("SELECT d from  Advertisement d");
	...
	@Override
	@Transactional
	public void save(Advertisement dept) {
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		session.save(dept);
		tx.commit();
	...
	@Override
	@Transactional
	public void update(Advertisement dept) {
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
	...
	@Override
	public Boolean IsExist(String Advertisement) {
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		Query q = session.createQuery("SELECT COUNT(d) FROM Advertisement d where LOWER(Advertisement)=LOWER('"+Advertisement+"')");
		Long count = (Long) q.list().get(0);
		tx.commit();
		session.close();
		if(count>0)
	...
	public List<Advertisement> getItemByModel(int page, int recordsPerPage) {
		...
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		Query q = session.createQuery("FROM Advertisement order by createdDate desc,frequency desc" );
		q.setFirstResult(page); 
        q.setMaxResults(recordsPerPage);
		list = (List<Advertisement>) q.list();
		tx.commit();
		session.close();
	...
	public List<Advertisement> getItemByFrequency(int page, int recordsPerPage) {
		...
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		Query q = session.createQuery("FROM Advertisement order by frequency desc, createdDate desc" );
		q.setFirstResult(page); 
        q.setMaxResults(recordsPerPage);
		list = (List<Advertisement>) q.list();
		tx.commit();
	...
	public List<Advertisement> getItemByCity(int page, int recordsPerPage, String city) {
		...
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		Query q = session.createQuery("FROM Advertisement where lower(location) like '%"+city.toLowerCase()+"%' order by createdDate desc,frequency desc" );
		q.setFirstResult(page); 
        q.setMaxResults(recordsPerPage);
		list = (List<Advertisement>) q.list();
		tx.commit();
	...
	public List<Advertisement> getItemByActiveModel(int page, int recordsPerPage) {
		...
		Session session= HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		Query q = session.createQuery("FROM Advertisement where active=true order by createdDate asc,frequency desc" );
		q.setFirstResult(page); 
        q.setMaxResults(recordsPerPage);
		list = (List<Advertisement>) q.list();
		tx.commit();
