...
function actions(data, type, full) {
		...
		f+='<a id="delete"  hreF="deleteVideo?id='+full.id+'" onclick="return (confirm(\'Are you sure?\'))" >Delete</a>';
	   return f;
	}
...
function select(id){	
	document.getElementById('videoIdsel').value=id;
	document.getElementById('selectForm').submit();	
}
function add(id){
	//alert(id);
	document.getElementById('videoId').value=id;
	document.getElementById('addVideoForm').submit();	
