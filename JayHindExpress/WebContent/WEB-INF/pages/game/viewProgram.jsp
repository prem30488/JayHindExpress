...
<script type="text/javascript" src="../js/game/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getGameList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addGameForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editGameForm" var="editUrl" />
	...
	<c:url value="selectGameForm" var="selectUrl" />
	...
	<c:url value="moreGamePhotos" var="addPhotoUrl" />
