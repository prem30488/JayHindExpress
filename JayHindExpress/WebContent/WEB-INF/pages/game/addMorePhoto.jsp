...
<html>
<head>
<script type="text/javascript" src="../js/game/dropzone.js"></script>
...
<br/><br/>
<center>
	<h1>Add More Game Photos</h1>
</center>
<br/><br/>
<a href="viewGames" style="color:black">View Game News</a> -> Add More Game Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadGamePhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
