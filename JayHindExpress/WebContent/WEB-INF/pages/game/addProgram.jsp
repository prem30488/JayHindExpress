...
<center>
	<h1>Add Game News Details</h1>
</center>
<br/><br/>
<script src="../js/game/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewGames" style="color:black">View Game News</a> -> Add Game News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addGame?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
