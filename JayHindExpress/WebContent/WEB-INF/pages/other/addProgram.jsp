...
<center>
	<h1>Add Other News Details</h1>
</center>
<br/><br/>
<script src="../js/other/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewOtherPrograms" style="color:black">View Other News</a> -> Add Other News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addOtherProgram?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
