...
<script type="text/javascript" src="../js/other/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getOtherProgramList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addOtherProgramForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editOtherProgramForm" var="editUrl" />
	...
	<c:url value="selectOtherProgramForm" var="selectUrl" />
	...
	<c:url value="moreOtherPhotos" var="addPhotoUrl" />
