...
<html>
<head>
<script type="text/javascript" src="../js/other/dropzone.js"></script>
...
<br/><br/>
<center>
	<h1>Add More Other News Photos</h1>
</center>
<br/><br/>
<a href="viewOtherPrograms" style="color:black">View Other News</a> -> Add More Other News Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadOtherPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
