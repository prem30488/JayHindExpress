...
<script type="text/javascript" src="js/game/programs.js"></script>
   <div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewGamePrograms">Game News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectGameProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewGamePrograms" method='get' id="form">
