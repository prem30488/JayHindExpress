...
<script type="text/javascript" src="js/fashion/programs.js"></script>
   <div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewFashionPrograms">Fashion News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectFashionProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewFashionPrograms" method='get' id="form">
