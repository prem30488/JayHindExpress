...
<script type="text/javascript" src="js/advertisement/programs.js"></script>

<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewAdvertisementPrograms">Advertisement News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectAdvertisementProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewAdvertisementPrograms" method='get' id="form">
