...
<script type="text/javascript" src="js/international/programs.js"></script>

<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewPrograms">International News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewPrograms" method='get' id="form">
