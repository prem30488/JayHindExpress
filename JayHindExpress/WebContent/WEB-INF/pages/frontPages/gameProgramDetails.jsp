...
<div class="single_page">
            <ol class="breadcrumb">
              ...
              <li><a href="viewGamePrograms">Game News</a></li>
              <li class="active">${program.programName}</li>
            </ol>
            <h1>Game News</h1>
            
            <div class="single_page_content"> 
            <h4><a href="selectGameProgram?id=${program.id}&albumName=${program.programName}">${program.programName }</a></h4>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                ...
                <c:if test="${sample.category eq 'game' }">
                <li>
                  <div class="media"> 
            ...
            <nav class="nav-slit"> 
	        <c:forEach items="${items}" var="sample" varStatus="s">
                <c:if test="${sample.category eq 'game' && sample.title ne program.programName}">
