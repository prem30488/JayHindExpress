...
<script type="text/javascript" src="js/business/programs.js"></script>

<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewBusinessPrograms">Business News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectBusinessProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewBusinessPrograms" method='get' id="form">
