...
<script type="text/javascript" src="js/entertainment/programs.js"></script>
   <div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewEntertainmentPrograms">Entertainment News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectEntertainmentProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewEntertainmentPrograms" method='get' id="form">
