...
<script type="text/javascript" src="js/other/programs.js"></script>
  <div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewOtherPrograms">Other News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectOtherProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewOtherPrograms" method='get' id="form">
