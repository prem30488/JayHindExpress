...
<script type="text/javascript" src="js/greeting/programs.js"></script>

<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewGreetingPrograms">Greeting News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectGreetingProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewGreetingPrograms" method='get' id="form">
