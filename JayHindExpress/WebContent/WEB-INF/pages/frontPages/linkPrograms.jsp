...
<script type="text/javascript" src="js/link/programs.js"></script>

<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewLinkPrograms">Link News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectLinkProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewLinkPrograms" method='get' id="form">
