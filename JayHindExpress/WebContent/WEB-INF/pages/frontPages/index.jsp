			...
			<div class="art-layout-cell art-content">
				...
				<article class="art-post art-article">
					<div class="art-postcontent art-postcontent-0 clearfix">
								<div class="art-content-layout">
										<div class="art-content-layout-row">
										<div class="art-layout-cell layout-item-0" style="width: 33.5%;word-wrap:break-word;">
										<h3>International</h3>
										...
										<div class="art-layout-cell layout-item-1" style="width: 33%;word-wrap:break-word;">
										...
										<div class="art-content-layout">
											<div class="art-content-layout-row">
												...
												<div class="art-layout-cell layout-item-0" style="width: 33.5%;word-wrap:break-word;">
													...
													<ul>
														<li>
															<span style="color: rgb(53, 52, 19);">
																<span style="font-weight: bold;">
																	<a href="selectNationalProgram?id=${program.id}&albumName=${program.programName}">${program.programName}</a>
																</span>&nbsp;<br/>
															</span>
															<br /> 
												...
												<div class="art-layout-cell layout-item-1" style="width: 33.5%;word-wrap:break-word;">
													<h3>State</h3>
													...
													<ul>
														<li>
															<span style="color: rgb(53, 52, 19);">
																<span style="font-weight: bold;">
																	<a href="selectStateProgram?id=${program.id}&albumName=${program.programName}">${program.programName}</a>
																</span>&nbsp;<br/>
															</span>
															<br /> 
								...
								<div class="art-layout-cell layout-item-0" style="width: 40%;word-wrap:break-word;">
									...
									<ul>
										<li>
											<span style="color: rgb(53, 52, 19);">
											<span style="font-weight: bold;">
											<a href="selectBusinessProgram?id=${program.id}&albumName=${program.programName}">${program.programName}</a>
											</span>&nbsp;<br/>
											</span>
											<br /> 
											<b>${program.location} :</b>		
								...
								<div class="art-layout-cell layout-item-0" style="width: 30%;word-wrap:break-word;">
									...
									<ul>
										<li>
											<span style="color: rgb(53, 52, 19);">
											<span style="font-weight: bold;">
											<a href="selectSportProgram?id=${program.id}&albumName=${program.programName}">${program.programName}</a>
											</span>&nbsp;<br/>
											</span><br /> 
											<b>${program.location} :</b>
											<fmt:formatDate value="${program.createdDate}" pattern="dd-MMM-yyyy hh:mm" />
								...
								<div class="art-layout-cell layout-item-0" style="width: 30%;word-wrap:break-word;">
									...
									<ul>
										<li><span style="color: rgb(53, 52, 19);"><span
												...
												<a href="selectTechnologyProgram?id=${program.id}&albumName=${program.programName}">${program.programName}</a>
											</span>&nbsp;<br/>
											</span><br /> 
											<b>${program.location} :</b><fmt:formatDate value="${program.createdDate}" pattern="dd-MMM-yyyy hh:mm" />
											<br/>
				...
				<article class="art-post art-article">
					...
					<div class="art-content-layout">
							<div class="art-content-layout-row">
								...
								<div class="art-layout-cell layout-item-0" style="width: 50%;word-wrap:break-word;">
									<p>
										<span style="font-weight: bold;"><a href="selectEntertainmentProgram?id=${program.id}&albumName=${program.programName}">${program.programName}</a></span>&nbsp;
										<br/><b>${program.location} :</b>
										<fmt:formatDate value="${program.createdDate}" pattern="dd-MMM-yyyy hh:mm" />
											<br/>				
											${program.niceCreatedDate}
											<br/>
