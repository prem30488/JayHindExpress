...
<div class="single_page">
            <ol class="breadcrumb">
              ...
              <li><a href="viewPhotographyPrograms">Photography News</a></li>
              <li class="active">${program.programName}</li>
            </ol>
            <h1>Photography News</h1>
            
            <div class="single_page_content"> 
            <h4><a href="selectPhotographyProgram?id=${program.id}&albumName=${program.programName}">${program.programName }</a></h4>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                ...
                <c:if test="${sample.category eq 'photography' }">
                <li>
                  <div class="media"> 
            ...
            <nav class="nav-slit"> 
	        <c:forEach items="${photographylist}" var="sample" varStatus="s">
                <c:if test="${sample.programName ne program.programName}">
                <c:if test="${nav==1}">
	        		<a class="prev" href="selectPhotographyProgram?id=${program.id}"> <span class="icon-wrap"><i class="fa fa-angle-left"></i></span>
	        		<div>
	        	...
	        	<c:if test="${nav==2}">
	        	<a class="next" href="${sample.photourl}"> <span class="icon-wrap"><i class="fa fa-angle-right"></i></span>
	        	<div>
	          	<h3>${sample.programName}</h3>
	          	<img src="${sample.photourl}" alt=""/> </div>
	        	</a> 
