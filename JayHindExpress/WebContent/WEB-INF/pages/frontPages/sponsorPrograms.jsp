...
<script type="text/javascript" src="js/sponsor/programs.js"></script>

<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewSponsorPrograms">Sponsor News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectSponsorProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewSponsorPrograms" method='get' id="form">
