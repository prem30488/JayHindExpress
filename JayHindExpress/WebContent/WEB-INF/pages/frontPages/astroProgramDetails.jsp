...
<div class="single_page">
            ...
            <h1>Astro & Dharma News</h1>
            
            <div class="single_page_content"> 
            <h4><a href="selectAstroProgram?id=${program.id}&albumName=${program.programName}">${program.programName }</a></h4>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                ...
                <c:if test="${sample.category eq 'astro' }">
                <li>
                  <div class="media"> 
            ...
            <nav class="nav-slit"> 
	        <c:forEach items="${items}" var="sample" varStatus="s">
                <c:if test="${sample.category eq 'astro' && sample.title ne program.programName}">
