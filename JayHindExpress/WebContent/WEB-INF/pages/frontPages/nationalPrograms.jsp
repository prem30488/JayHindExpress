...
<script type="text/javascript" src="js/national/programs.js"></script>
   
<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewNationalPrograms">National News</a></li>
            ...
            <h4><a href="selectNationalProgram?id=${program.id}&albumName=${program.programName}">${program.programName }</a></h4>
            ...
            <br/><br/><br/><br/>
            <a href="selectNationalProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewNationalPrograms" method='get' id="form">
