...
<script type="text/javascript" src="js/astro/programs.js"></script>
  
  <div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewAstroPrograms">Astro & Dharma</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectAstroProgram?id=${program.id}&albumName=${program.programName}">
					...
					<c:forEach begin="1" end="${noOfPages}" var="i">
						<ul>
							<c:choose>
								...
								<c:otherwise>
									<%-- <td id="next" style="width: 20px;"><a href="getItemByModel?from_model=${param.from_model}&to_model=${param.to_model}&page=${i}">${i}</a></td>
					 --%>
  ...
  <form:form  action="viewAstroPrograms" method='get' id="form">
