...
<script type="text/javascript" src="js/state/programs.js"></script>
   
<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewStatePrograms">State News</a></li>
            ...
            <h4><a href="selectStateProgram?id=${program.id}&albumName=${program.programName}">${program.programName }</a></h4>
            ...
            <br/><br/><br/><br/>
            <a href="selectStateProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewStatePrograms" method='get' id="form">
