...
<script type="text/javascript" src="js/sports/programs.js"></script>
   
<div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewSportPrograms">Sports News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectSportProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewSportPrograms" method='get' id="form">
