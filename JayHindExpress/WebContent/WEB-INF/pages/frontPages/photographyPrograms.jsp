...
<script type="text/javascript" src="js/photography/programs.js"></script>
   <div class="single_page">
            <ol class="breadcrumb">
              <li><a href="Home">Home</a></li>
              <li class="active"><a href="viewPhotographyPrograms">Photography News</a></li>
            ...
            <br/><br/><br/><br/>
            <a href="selectPhotographyProgram?id=${program.id}&albumName=${program.programName}">
  ...
  <form:form  action="viewPhotographyPrograms" method='get' id="form">
