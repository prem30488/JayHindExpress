...
<div class="single_page">
            ...
            <h4><a href="selectEntertainmentProgram?id=${program.id}&albumName=${program.programName}">${program.programName }</a></h4>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                ...
                <c:if test="${sample.category eq 'entertainment' }">
                <li>
                  <div class="media"> 
            ...
            <nav class="nav-slit"> 
	        <c:forEach items="${items}" var="sample" varStatus="s">
                <c:if test="${sample.category eq 'entertainment' && sample.title ne program.programName}">
