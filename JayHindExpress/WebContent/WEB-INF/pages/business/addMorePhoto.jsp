...
<html>
<head>
<script type="text/javascript" src="../js/business/dropzone.js"></script>
...
<br/><br/>
<a href="viewBusiness" style="color:black">View Business News</a> -> Add More Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadBusinessPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
