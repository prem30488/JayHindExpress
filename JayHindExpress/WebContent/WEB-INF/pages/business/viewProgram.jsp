...
<script type="text/javascript" src="../js/business/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getBusinessList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addBusinessForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editBusinessForm" var="editUrl" />
	...
	<c:url value="selectBusinessForm" var="selectUrl" />
	...
	<c:url value="moreBusinessPhotos" var="addPhotoUrl" />
