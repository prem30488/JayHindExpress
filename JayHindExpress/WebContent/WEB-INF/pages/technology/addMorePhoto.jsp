...
<html>
<head>
<script type="text/javascript" src="../js/technology/dropzone.js"></script>
...
<br/><br/>
<center>
	<h1>Add More Technology Photos</h1>
</center>
<br/><br/>
<a href="viewTechnologies" style="color:black">View Technology News</a> -> Add More Technology Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadTechnologyPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
