...
<center>
	<h1>Add Technology News Details</h1>
</center>
<br/><br/>
<script src="../js/technology/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewTechnologies" style="color:black">View Technology News</a> -> Add Technology News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addTechnology?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
