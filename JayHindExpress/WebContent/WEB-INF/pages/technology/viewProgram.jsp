...
<script type="text/javascript" src="../js/technology/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getTechnologyList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addTechnologyForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editTechnologyForm" var="editUrl" />
	...
	<c:url value="selectTechnologyForm" var="selectUrl" />
	...
	<c:url value="moreTechnologyPhotos" var="addPhotoUrl" />
