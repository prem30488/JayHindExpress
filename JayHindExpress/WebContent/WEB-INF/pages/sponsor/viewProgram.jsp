...
<script type="text/javascript" src="../js/sponsor/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getSponsorList" serverSide="true" pipelining="true" pipeSize="3" 
    ...
    <datatables:column title="Sponsor" property="link" />
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addSponsorForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editSponsorForm" var="editUrl" />
	...
	<c:url value="selectSponsorForm" var="selectUrl" />
	...
	<c:url value="moreSponsorPhotos" var="addPhotoUrl" />
