...
<%@taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
 <center>
	<h1>Sponsor News Details</h1>
	</center>
<br/><br/>
<a href="viewSponsors" style="color:black">View Sponsor News</a> -> Sponsor News Details
<br/><br/>
<center>
			...
			<th>
			 ...
			 <div style="width:100%;height:100%;">
				 <c:forEach items="${fileList}" var="fileName" varStatus="status">
            	 	...
            	 	&nbsp;
            	 	<a href='deleteSponsorFile?fileDir=${fn:replace(fileDir, '\\', '/')}/${fileName}'>Delete</a>
            	 	<br/>
           		</c:forEach>
			</div>
			</td>  
