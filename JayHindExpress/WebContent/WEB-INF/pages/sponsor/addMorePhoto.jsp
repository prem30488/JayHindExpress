...
<html>
<head>
<script type="text/javascript" src="../js/sponsor/dropzone.js"></script>
...
<br/><br/>
<center>
	<h1>Add More Sponsor Photos</h1>
</center>
<br/><br/>
<a href="viewSponsors" style="color:black">View Sponsor News</a> -> Add More Sponsor Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadSponsorPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
