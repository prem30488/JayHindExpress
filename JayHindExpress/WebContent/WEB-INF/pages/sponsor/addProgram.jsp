...
<center>
	<h1>Add Sponsor News Details</h1>
</center>
<br/><br/>
<script src="../js/sponsor/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewSponsors" style="color:black">View Sponsor News</a> -> Add Sponsor News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addSponsor?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
		<table style="width: 100%">
			...
			<tr class="<c:if test="${status.error}"> trError </c:if>" style="width:300px;">
				...
				<td style="width:30%;">
					...
					<label for="active" class="error"></label>
				</td>
			</tr>
			</spring:bind>
