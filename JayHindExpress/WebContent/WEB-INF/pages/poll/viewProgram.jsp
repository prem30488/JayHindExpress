...
<script type="text/javascript" src="../js/poll/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getPollList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addPollForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editPollForm" var="editUrl" />
	...
	<c:url value="selectPollForm" var="selectUrl" />
