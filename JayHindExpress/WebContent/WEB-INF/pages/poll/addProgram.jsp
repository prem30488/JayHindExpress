...
<center>
	<h1>Add Poll Details</h1>
</center>
<br/><br/>
<script src="../js/poll/programs.js"></script>
<a href="viewPolls" style="color:black">View Poll News</a> -> Add Poll Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addPoll?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
