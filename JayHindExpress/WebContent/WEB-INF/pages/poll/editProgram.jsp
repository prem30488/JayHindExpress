...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<center>
	<h1>Edit Poll Details</h1>
</center>
<br/><br/>
<a href="viewPolls" style="color:black">View Poll News</a> -> Edit Poll Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="updatePoll?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
