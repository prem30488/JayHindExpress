...
<a href="viewVideos" style="color:black">View Videos</a> -> Edit Video Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="video" method='POST' action="updateVideo?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
		<table style="width: 100%">
			...
			<tr>
				<td colspan="3" align="center">
					<input name="submit" type="submit" value="Edit Video" onclick="return validate();" class="button"/>
