...
<script type="text/javascript" src="../js/video/viewVideo.js"></script>
...
<center>
	...
	<datatables:table id="videotbl" url="getVideoList" serverSide="true" pipelining="true" pipeSize="3" 
    ...
    <datatables:column title="Video Name" property="videoName" />
    <datatables:column title="Video ID" property="video_id" />
    <datatables:column title="Posted by" property="posted_by" />
    <datatables:column title="Location" property="location" />
</datatables:table>
	<br/>
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addVideoForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editVideoForm" var="editUrl" />
	<form:form action="${editUrl}" method="post" id="editForm" name="editForm" modelAttribute="videoId">
		<input type="hidden" name="videoId" id="videoId" value="0"/>
	</form:form>	
	
	<c:url value="selectVideoForm" var="selectUrl" />
	<form:form action="${selectUrl}" method="post" id="selectForm" name="selectForm" modelAttribute="programIdsel">
		<input type="hidden" name="videoIdsel" id="videoIdsel" value="0"/>
	</form:form>
	
	<c:url value="morePhotos" var="addPhotoUrl" />
