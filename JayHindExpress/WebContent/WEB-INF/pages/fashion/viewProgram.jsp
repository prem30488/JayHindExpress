...
<script type="text/javascript" src="../js/fashion/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getFashionList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addFashionForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editFashionForm" var="editUrl" />
	...
	<c:url value="selectFashionForm" var="selectUrl" />
	...
	<c:url value="moreFashionPhotos" var="addPhotoUrl" />
