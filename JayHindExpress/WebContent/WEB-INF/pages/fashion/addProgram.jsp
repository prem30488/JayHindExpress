...
<center>
	<h1>Add Fashion News Details</h1>
</center>
<br/><br/>
<script src="../js/fashion/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewFashions" style="color:black">View Fashion News</a> -> Add Fashion News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addFashion?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
