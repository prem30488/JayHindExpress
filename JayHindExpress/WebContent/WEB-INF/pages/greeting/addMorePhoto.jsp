...
<html>
<head>
<script type="text/javascript" src="../js/greeting/dropzone.js"></script>
...
<br/><br/>
<center>
	<h1>Add More Greeting Photos</h1>
</center>
<br/><br/>
<a href="viewGreetings" style="color:black">View Greeting News</a> -> Add More Greeting Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadGreetingPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
