...
<center>
	<h1>Add Greeting News Details</h1>
</center>
<br/><br/>
<script src="../js/greeting/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewGreetings" style="color:black">View Greeting News</a> -> Add Greeting News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addGreeting?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
