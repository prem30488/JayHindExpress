...
<script type="text/javascript" src="../js/greeting/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getGreetingList" serverSide="true" pipelining="true" pipeSize="3" 
    ...
    <datatables:column title="Greeting" property="link" />
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addGreetingForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editGreetingForm" var="editUrl" />
	...
	<c:url value="selectGreetingForm" var="selectUrl" />
	...
	<c:url value="moreGreetingPhotos" var="addPhotoUrl" />
