...
<center>
	<h1>Add State News Details</h1>
</center>
<br/><br/>
<script src="../js/state/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewStatePrograms" style="color:black">View State News</a> -> Add State News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addStateProgram?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
