...
<script type="text/javascript" src="../js/state/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getStateProgramList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addStateProgramForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editStateProgramForm" var="editUrl" />
	...
	<c:url value="selectStateProgramForm" var="selectUrl" />
	...
	<c:url value="moreStatePhotos" var="addPhotoUrl" />
