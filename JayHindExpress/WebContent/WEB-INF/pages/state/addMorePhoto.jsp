...
<html>
<head>
<script type="text/javascript" src="../js/state/dropzone.js"></script>
...
<br/><br/>
<center>
	<h1>Add More State News Photos</h1>
</center>
<br/><br/>
<a href="viewStatePrograms" style="color:black">View State News</a> -> Add More State News Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadStatePhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
