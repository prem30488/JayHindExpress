...
<script type="text/javascript" src="../js/international/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getProgramList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addProgramForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editProgramForm" var="editUrl" />
	...
	<c:url value="selectProgramForm" var="selectUrl" />
