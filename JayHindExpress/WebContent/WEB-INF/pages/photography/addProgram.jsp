...
<center>
	<h1>Add Photography News Details</h1>
</center>
<br/><br/>
<script src="../js/photography/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewPhotographys" style="color:black">View Photography News</a> -> Add Photography News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addPhotography?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
