...
<script type="text/javascript" src="../js/photography/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getPhotographyList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addPhotographyForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editPhotographyForm" var="editUrl" />
	...
	<c:url value="selectPhotographyForm" var="selectUrl" />
	...
	<c:url value="morePhotographyPhotos" var="addPhotoUrl" />
