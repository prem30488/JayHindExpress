...
<script type="text/javascript" src="../js/entertainment/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getEntertainmentList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addEntertainmentForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editEntertainmentForm" var="editUrl" />
	...
	<c:url value="selectEntertainmentForm" var="selectUrl" />
	...
	<c:url value="moreEntertainmentPhotos" var="addPhotoUrl" />
