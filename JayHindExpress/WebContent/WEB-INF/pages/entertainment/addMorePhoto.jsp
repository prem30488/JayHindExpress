...
<html>
<head>
<script type="text/javascript" src="../js/entertainment/dropzone.js"></script>
...
<br/><br/>
<center>
	<h1>Add More Entertainment Photos</h1>
</center>
<br/><br/>
<a href="viewEntertainments" style="color:black">View Entertainment News</a> -> Add More Entertainment Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadEntertainmentPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
