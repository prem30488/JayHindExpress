...
<center>
	<h1>Add Entertainment News Details</h1>
</center>
<br/><br/>
<script src="../js/entertainment/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewEntertainments" style="color:black">View Entertainment News</a> -> Add Entertainment News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addEntertainment?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
