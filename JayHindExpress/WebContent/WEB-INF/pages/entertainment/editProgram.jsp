...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<center>
	<h1>Edit Entertainment News Details</h1>
</center>
<br/><br/>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewEntertainments" style="color:black">View Entertainment News</a> -> Edit Entertainment News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="updateEntertainment?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
