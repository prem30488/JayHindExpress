...
<center>
	<h1>Add Advertisement News Details</h1>
</center>
<br/><br/>
<script src="../js/advertisement/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewAdvertisements" style="color:black">View Advertisement News</a> -> Add Advertisement News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addAdvertisement?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
