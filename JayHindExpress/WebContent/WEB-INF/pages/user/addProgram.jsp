...
<br/><br/>
<script src="../js/user/programs.js"></script>
...
<a href="viewUsers" style="color:black">View Users</a> -> Add User Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addUser?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
