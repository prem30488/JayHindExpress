...
<html>
<head>
<script type="text/javascript" src="../js/user/dropzone.js"></script>
...
<br/><br/>
<a href="viewUsers" style="color:black">View Users</a> -> Add More Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadUserPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
