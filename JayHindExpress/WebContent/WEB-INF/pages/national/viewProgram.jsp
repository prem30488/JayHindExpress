...
<script type="text/javascript" src="../js/national/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getNationalProgramList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addNationalProgramForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editNationalProgramForm" var="editUrl" />
	...
	<c:url value="selectNationalProgramForm" var="selectUrl" />
	...
	<c:url value="moreNationalPhotos" var="addPhotoUrl" />
