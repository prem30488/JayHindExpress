...
<br/><br/>
<center>
	<h1>Add More National News Photos</h1>
</center>
<br/><br/>
<a href="viewNationalPrograms" style="color:black">View National News</a> -> Add More National News Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadNationalPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
