...
<center>
	<h1>Add National News Details</h1>
</center>
<br/><br/>
<script src="../js/national/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewNationalPrograms" style="color:black">View National News</a> -> Add National News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addNationalProgram?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
