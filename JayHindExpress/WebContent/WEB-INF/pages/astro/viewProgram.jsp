...
<script type="text/javascript" src="../js/astro/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getAstroList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addAstroForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editAstroForm" var="editUrl" />
	...
	<c:url value="selectAstroForm" var="selectUrl" />
	...
	<c:url value="moreAstroPhotos" var="addPhotoUrl" />
