...
<br/><br/>
<center>
	<h1>Add More Astro & Dharma Photos</h1>
</center>
<br/><br/>
<a href="viewAstro" style="color:black">View Astro & Dharma News</a> -> Add More Astro & Dharma Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadAstroPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
