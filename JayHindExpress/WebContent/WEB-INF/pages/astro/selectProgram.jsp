...
<%@taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
 <center>
	<h1>Astro & Dharma News Details</h1>
	</center>
<br/><br/>
<a href="viewAstro" style="color:black">View Astro & Dharma News</a> -> Astro & Dharma News Details
<br/><br/>
<center>
			...
			<th>
			 ...
			 <div style="width:100%;height:100%;">
				 <c:forEach items="${fileList}" var="fileName" varStatus="status">
            	 	...
            	 	&nbsp;
            	 	<a href='deleteAstroFile?fileDir=${fn:replace(fileDir, '\\', '/')}/${fileName}'>Delete</a>
            	 	<br/>
           		</c:forEach>
			</div>
			</td>  
