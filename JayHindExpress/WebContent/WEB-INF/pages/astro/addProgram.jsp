...
<center>
	<h1>Add Astro & Dharma News Details</h1>
</center>
<br/><br/>
<script src="../js/astro/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewAstro" style="color:black">View Astro & Dharma News</a> -> Add Astro & Dharma News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addAstro?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
