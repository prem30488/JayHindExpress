...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<center>
	<h1>Edit Astro & Dharma News Details</h1>
</center>
<br/><br/>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewAstro" style="color:black">View Astro & Dharma News</a> -> Edit Astro & Dharma News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="updateAstro?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
