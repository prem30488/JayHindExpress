...
<script type="text/javascript" src="../js/sports/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getSportList" serverSide="true" pipelining="true" pipeSize="3" 
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addSportForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editSportForm" var="editUrl" />
	...
	<c:url value="selectSportForm" var="selectUrl" />
	...
	<c:url value="moreSportPhotos" var="addPhotoUrl" />
