...
<br/><br/>
<center>
	<h1>Add More Sports Photos</h1>
</center>
<br/><br/>
<a href="viewSports" style="color:black">View Sports News</a> -> Add More Sports Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadSportPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
