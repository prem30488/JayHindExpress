...
<center>
	<h1>Add Sports News Details</h1>
</center>
<br/><br/>
<script src="../js/sports/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewSports" style="color:black">View Sports News</a> -> Add Sports News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addSport?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
