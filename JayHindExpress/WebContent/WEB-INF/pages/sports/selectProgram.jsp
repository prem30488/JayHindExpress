...
<%@taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
 <center>
	<h1>Sports News Details</h1>
	</center>
<br/><br/>
<a href="viewSports" style="color:black">View Sports News</a> -> Sports News Details
<br/><br/>
<center>
			...
			<th>
			 ...
			 <div style="width:100%;height:100%;">
				 <c:forEach items="${fileList}" var="fileName" varStatus="status">
            	 	...
            	 	&nbsp;
            	 	<a href='deleteSportFile?fileDir=${fn:replace(fileDir, '\\', '/')}/${fileName}'>Delete</a>
            	 	<br/>
           		</c:forEach>
			</div>
			</td>  
