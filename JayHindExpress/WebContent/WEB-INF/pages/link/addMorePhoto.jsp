...
<br/><br/>
<center>
	<h1>Add More Link Photos</h1>
</center>
<br/><br/>
<a href="viewLinks" style="color:black">View Link News</a> -> Add More Link Photos
<br/><br/>
<center>
...
<form:form name="douploadPhoto"  method="post" action="douploadLinkPhoto?${_csrf.parameterName}=${_csrf.token}" commandName="uploadPhoto"  enctype="multipart/form-data" class="dropzone"
