...
<script type="text/javascript" src="../js/link/viewProgram.js"></script>
...
<center>
	...
	<datatables:table id="programstbl" url="getLinkList" serverSide="true" pipelining="true" pipeSize="3" 
    ...
    <datatables:column title="Link" property="link" />
	...
	<div style="float: right;">
		<form name="addDepartment" id="addDepartment" action="addLinkForm" method='get'>
			<table>
				<tr>
	...
	<c:url value="editLinkForm" var="editUrl" />
	...
	<c:url value="selectLinkForm" var="selectUrl" />
	...
	<c:url value="moreLinkPhotos" var="addPhotoUrl" />
