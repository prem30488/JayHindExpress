...
<center>
	<h1>Add Link News Details</h1>
</center>
<br/><br/>
<script src="../js/link/programs.js"></script>
<script src="../js/ckeditor4.6.2/ckeditor.js"></script>
<a href="viewLinks" style="color:black">View Link News</a> -> Add Link News Details
<br/><br/>
<center>
	<form:form id="programForm" name="programForm" modelAttribute="program" method='POST' action="addLink?${_csrf.parameterName}=${_csrf.token}"  enctype="multipart/form-data">
